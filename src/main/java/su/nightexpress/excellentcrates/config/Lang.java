...
public class Lang implements LangContainer {
    ...
    public static final BooleanLocale INSPECTIONS_CRATE_HOLOGRAM     = LangEntry.builder("Inspections.Crate.Hologram").bool("Hologram text is valid.", "Hologram text is empty!");
